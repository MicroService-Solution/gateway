...
class AssertTest extends TestCase
{
    ...
    public function testAssertContainsOnlyInstancesOf(): void
    {
        ...
        $this->assertContainsOnlyInstancesOf(\Test::class, $test);
        ...
        $this->assertContainsOnlyInstancesOf(\Test::class, $test2);
    }
...
XML;
    ...
    {
        $this->assertThat([new \Test], $this->containsOnlyInstancesOf(\Test::class));
    }
